package com.duo.ranking.common;
...
public class Pagination {
    ...
    private int firstRecordIndex; //(기존 curPos)페이지당 시작 인덱스 0, 5, 10, 15 ...
    private int startPage;
    private int lastRecordIndex;  //페이지당 마지막 인덱스	5,10,15,20....
    
    public int getStartPage(){
        startPage = (currentPage-1)*recordCountPerPage;
        return startPage;
    }
